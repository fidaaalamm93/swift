...
struct DialogView: View {
    ...
    @State private var selected = Set<RuptDevice>()
    var onDetach: ((Set<RuptDevice>) -> Void)? = nil
    var body: some View {
        VStack {
            if viewModel.loadingDevices {
                ...
                List(viewModel.attachedDevices, id: \.self, selection: $selected) { device in
                    HStack {
                        ...
                        if device.info.device?.type == RuptDeviceType.mobile.rawValue {
                            Image(systemName: "iphone")
                                .font(.title)
                                .frame(width: 50, height: 50)
                        } else if device.info.device?.type == RuptDeviceType.tablet.rawValue {
...
struct DialogView_Previews: PreviewProvider {
    static var previews: some View {
        let viewModel = DialogViewModel(currentDeviceID: "1",
                                        attachedDevices: [
                                            RuptDevice(id: "0", info: RuptDeviceInfo(os: RuptOS(name: "Mac OS", version: "1.0"), device: RuptDeviceDetails(vendor: "Apple", type: nil, model: nil)), user: "xyz", createdAt: Date(), updatedAt: Date()),
                                            RuptDevice(id: "1", info: RuptDeviceInfo(os: RuptOS(name: "iOS", version: "1.0"), device: RuptDeviceDetails(vendor: "Apple", type: "mobile", model: "iPhone 13")), user: "xyz", createdAt: Date(), updatedAt: Date()),
                                            RuptDevice(id: "2", info: RuptDeviceInfo(os: RuptOS(name: "iOS", version: "1.0"), device: RuptDeviceDetails(vendor: "Apple", type: "tablet", model: "iPad 5")), user: "xyz", createdAt: Date(), updatedAt: Date()),
                                            RuptDevice(id: "3", info: RuptDeviceInfo(os: RuptOS(name: "iOS", version: "1.0"), device: RuptDeviceDetails(vendor: "Apple", type: "mobile", model: "iPhone 13")), user: "xyz", createdAt: Date(), updatedAt: Date()),
                                            RuptDevice(id: "4", info: RuptDeviceInfo(os: RuptOS(name: "Windows", version: "1.0"), device: RuptDeviceDetails(vendor: "Apple", type: "", model: "iPhone 13")), user: "xyz", createdAt: Date(), updatedAt: Date())
                                        ],
                                        limitConfig: RuptLimitConfig(mobileLimit: 1, overallLimit: 1))
